...
#define __PYX_HAVE___tn93
#define __PYX_HAVE_API___tn93
#include "tn93.h"
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from '_tn93' */
#define __Pyx_MODULE_NAME "_tn93"
int __pyx_module_is_main__tn93 = 0;

/* Implementation of '_tn93' */
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC init_tn93(void); /*proto*/
PyMODINIT_FUNC init_tn93(void)
#else
PyMODINIT_FUNC PyInit__tn93(void); /*proto*/
PyMODINIT_FUNC PyInit__tn93(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannyDeclarations
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__tn93(void)", 0);
  ...
  #endif
  if (__pyx_module_is_main__tn93) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "_tn93")) {
      if (unlikely(PyDict_SetItemString(modules, "_tn93", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init _tn93", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init _tn93");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
